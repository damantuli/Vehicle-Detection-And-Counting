...
def drawBoundingBox(opening,frame,count_cars,count_bikes,min_length,width,height):
	...
	for cnt in contours:
		...
		cnts.append(cnt)
	cv2.line(frame,(50,height),(width-20,height),(0,255,0),3)
	cv2.line(frame,(50,height-30),(width-20,height-30),(0,255,0),3)
	cv2.line(frame,(50,height+30),(width-20,height+30),(0,255,0),3)

	old_centroids , new_centroids = getCentroids(old_boxes) , getCentroids(new_boxes)
	count_cars , count_bikes = check(height,count_cars,count_bikes,old_centroids,new_centroids,cnts,40,7000)
